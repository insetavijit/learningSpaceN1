...
| Topic                                        | Focus & Purpose                                                                                                                                                                                                                         |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[[02 Git Syllabus]]**    | `var`, `let`, `const` declarations; block scope vs function scope; hoisting behavior; temporal dead zone; variable lifecycle and memory. Establishes the non-negotiable rules for variable access and lifetime.                         |
